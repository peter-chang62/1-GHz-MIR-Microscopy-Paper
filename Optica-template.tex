...
% re-position the "which is a two order magnitude improvement...". Because after all there should be some ending statement that makes this analysis relevant. Such as therefore the pixel dwell time really scales with f_r as ... 
