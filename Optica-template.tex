...
% Practically speaking, for a fixed optical bandwidth, frequency resolution and target SNR, the imaging speed follows a $f_r^3$ scaling (\mbox{Fig. \ref{fig:snr_analysis}.(b)}).
