...
\section{Abstract}
The development of compact and robust platforms that occupy the intersection of high speed and broad bandwidth in the mid-infrared is of central importance in vibrational imaging. In this work, we experimentally motivate the combination of broadband and high-rep rate dual comb spectrometers (DCS) in the mid-infrared with a scanning microscope. To demonstrate, we utilize a set of 1-GHz mid-infrared frequency combs for high speed and broadband hyperspectral imaging. The system covers \mbox{1000 $\mathrm{cm^{-1}}$} at \mbox{$\mathrm{\lambda_c=3.4 \; \mu m}$} with 13.47 kHz spectra acquisition rate and \mbox{4 $\mathrm{\mu m}$} spatial resolution. Furthermore, we elucidate the bandwidth and speed trade-off of DCS as it applies to microscopy, mapping out a path for future development of high rep-rate DCS hyperspectral imaging.
